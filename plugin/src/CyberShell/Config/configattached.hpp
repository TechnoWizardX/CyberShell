...
class Config : public QQuickAttachedPropertyPropagator, public QQmlParserStatus {
    ...
    Q_PROPERTY(const cybershell::config::AppearanceConfig* appearance READ appearance NOTIFY sourceChanged)
    Q_PROPERTY(const cybershell::config::GeneralConfig* general READ general NOTIFY sourceChanged)
    Q_PROPERTY(const cybershell::config::BackgroundConfig* background READ background NOTIFY sourceChanged)
    Q_PROPERTY(const cybershell::config::BarConfig* bar READ bar NOTIFY sourceChanged)
    Q_PROPERTY(const cybershell::config::BorderConfig* border READ border NOTIFY sourceChanged)
    Q_PROPERTY(const cybershell::config::DashboardConfig* dashboard READ dashboard NOTIFY sourceChanged)
    Q_PROPERTY(const cybershell::config::LauncherConfig* launcher READ launcher NOTIFY sourceChanged)
    Q_PROPERTY(const cybershell::config::LockConfig* lock READ lock NOTIFY sourceChanged)
    Q_PROPERTY(const cybershell::config::NexusConfig* nexus READ nexus NOTIFY sourceChanged)
    Q_PROPERTY(const cybershell::config::NotifsConfig* notifs READ notifs NOTIFY sourceChanged)
    Q_PROPERTY(const cybershell::config::OsdConfig* osd READ osd NOTIFY sourceChanged)
    Q_PROPERTY(const cybershell::config::ServiceConfig* services READ services NOTIFY sourceChanged)
    Q_PROPERTY(const cybershell::config::SessionConfig* session READ session NOTIFY sourceChanged)
    Q_PROPERTY(const cybershell::config::SidebarConfig* sidebar READ sidebar NOTIFY sourceChanged)
    Q_PROPERTY(const cybershell::config::UtilitiesConfig* utilities READ utilities NOTIFY sourceChanged)
    Q_PROPERTY(const cybershell::config::WInfoConfig* winfo READ winfo NOTIFY sourceChanged)
    Q_PROPERTY(const cybershell::config::UserPaths* paths READ paths NOTIFY sourceChanged)
