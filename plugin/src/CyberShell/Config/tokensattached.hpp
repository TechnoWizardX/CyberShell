...
class Tokens : public QQuickAttachedPropertyPropagator, public QQmlParserStatus {
    ...
    Q_PROPERTY(const cybershell::config::AppearanceRounding* rounding READ rounding NOTIFY sourceChanged)
    Q_PROPERTY(const cybershell::config::AppearanceSpacing* spacing READ spacing NOTIFY sourceChanged)
    Q_PROPERTY(const cybershell::config::AppearancePadding* padding READ padding NOTIFY sourceChanged)
    Q_PROPERTY(const cybershell::config::AppearanceTransparency* transparency READ transparency NOTIFY sourceChanged)
    Q_PROPERTY(const cybershell::config::SizeTokens* sizes READ sizes NOTIFY sourceChanged)
    Q_PROPERTY(const cybershell::config::FontTokens* font READ font NOTIFY sourceChanged)
    Q_PROPERTY(const cybershell::config::AnimTokens* anim READ anim NOTIFY sourceChanged)
