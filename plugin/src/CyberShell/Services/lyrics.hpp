...
class Lyrics : public QObject {
    ...
    Q_PROPERTY(cybershell::services::LyricsBackend::Backend backend READ backend NOTIFY backendChanged)
    Q_PROPERTY(cybershell::services::LyricsBackend::Backend preferredBackend READ preferredBackend WRITE
            setPreferredBackend NOTIFY preferredBackendChanged)
    Q_PROPERTY(
        QList<cybershell::services::LyricCandidate> lyricCandidates READ lyricCandidates NOTIFY lyricCandidatesChanged)
    Q_PROPERTY(cybershell::services::LyricCandidate selectedCandidate READ selectedCandidate WRITE setSelectedCandidate
