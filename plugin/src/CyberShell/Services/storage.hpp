...
class Storage : public TickingService {
    ...
    Q_PROPERTY(QQmlListProperty<cybershell::services::DiskInfo> disks READ disksProp NOTIFY disksChanged)
    Q_PROPERTY(cybershell::services::DiskInfo* manualPrimaryDisk READ manualPrimaryDisk WRITE setManualPrimaryDisk NOTIFY
            manualPrimaryDiskChanged)
    Q_PROPERTY(cybershell::services::DiskInfo* primaryDisk READ primaryDisk NOTIFY primaryDiskChanged)
